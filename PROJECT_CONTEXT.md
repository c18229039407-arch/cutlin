...
Cutlin is an open-source, AI-orchestrated video production platform.
...
Layer 2: skills/                    → "How Cutlin uses them" (project conventions)
...
| `skills/core/hyperframes.md` | Layer 2 — when Cutlin should pick HyperFrames vs Remotion, artifact → workspace mapping |
