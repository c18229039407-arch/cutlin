"""Bridge Cutlin playbooks → HyperFrames-friendly style artifacts.

Cutlin playbooks are YAML files describing visual_language, typography,
...
def _render_design_md(
    ...
    lines = [
        title,
        "",
        f"> Generated by Cutlin HyperFrames style bridge (source: {source_note}).",
        "",
        "## Colors",
        "",
