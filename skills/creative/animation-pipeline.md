...
Animation work in Cutlin runs on one of two composition runtimes. Both
...
| **Web/explainer standard** | 30 | Default for YouTube/web video. Cutlin default. |
...
**Cutlin default:** 30fps. Render Manim at 60fps and transcode to 30fps for smoother motion at delivery frame rate.
...
1. **Render at 30fps** (Cutlin default) — Manim at 60fps, transcode down
