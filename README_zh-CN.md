...
> **“来自明天的信号 (SIGNAL FROM TOMORROW)”** — 一部完全通过 Cutlin 制作的电影级科幻预告片：包括概念、剧本、场景规划、Veo 生成的动态片段、配乐以及 Remotion 合成。
...
<p align="center">
  <a href="https://www.youtube.com/@Cutlin?sub_confirmation=1"><strong>订阅 YouTube 上的 @Cutlin</strong></a>，第一时间观看发布的最新视频 — 每个视频都包含了完整的提示词、流水线、使用的工具和成本，方便您自行复现。
</p>
...
我们使用 [GitHub Discussions](https://github.com/calesthio/Cutlin/discussions) 来分享作品与想法：

- **[展示与分享](https://github.com/calesthio/Cutlin/discussions/categories/show-and-tell)** — 分享您制作的视频、好用的提示词，或您发现的创意工作流
- **[想法](https://github.com/calesthio/Cutlin/discussions/categories/ideas)** — 提出新的流水线、工具、风格指南或集成的建议
- **[问答](https://github.com/calesthio/Cutlin/discussions/categories/q-a)** — 询问有关设置、流水线或故障排除的问题
...
有关错误反馈、功能请求和工作流讨论，请使用 [GitHub Issues](https://github.com/calesthio/Cutlin/issues) 和 [GitHub Discussions](https://github.com/calesthio/Cutlin/discussions)，以确保每件事都能保持可见和可操作。
